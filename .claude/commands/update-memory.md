---
description: Manually trigger session close memory updates
---

Manually trigger session close memory updates (same logic as session-protocol.md).

1. Read `rules/core/work-state.md` and `rules/core/memory.md`
...
4. **Offer session log** if the session was substantial
