...
**Note types and their required frontmatter** are defined in `rules/vault/vault-structure.md`. This kit ships the contract, not the templates — bring your own (Templater or otherwise) and make them emit the fields the hooks require.
...
The system separates **scaffolding** (rules, memory, hooks, commands, agents) from **content** (your notes, people, projects, decisions). The scaffolding is universal. The content is yours.
